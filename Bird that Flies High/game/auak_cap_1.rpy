...
label investigar_auak:
    ...
    auak "Acho que o barulho veio daqui."

    show professor grande abaixado at left
    with dissolve

    prof "Oi Auak. Bom te encontrar aqui."

    prof "Eu descobri o que foi. Vem comigo."
...
label esconder_auak:
    auak "Me avisa quando o professor voltar!"
    ...
    nerkk "Ele se escondeu. Vou chamar ele."

    nerkk "AUAK VOLTA AQUI!"

    show auak at right
    with dissolve

    prof "Eu descobri o que foi. Auak, vem comigo."
...
label xixi_auak:
    ...
    prof "Enfim, eu descobri o que aconteceu. Auak, vem comigo."
    
    jump acontecimento_1_auak

label acontecimento_1_auak:
